...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True,
        test_out_dir='alarad_rtmdet_eval',
...
interval = 10
launcher = 'none'
load_from = 'work_dirs/config_alarad/best_coco_bbox_mAP_epoch_100.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='/mmdetection/data/ALARAD_Strawberry_1060_c1/test.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    proposal_nums=(
...
val_dataloader = dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='/mmdetection/data/ALARAD_Strawberry_1060_c1/val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    proposal_nums=(
